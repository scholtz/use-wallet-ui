				...
				{providers?.map((provider) => (
					<div key={"provider-" + provider.metadata.id}>
						...
						<div className="wallet-menu-title">
							...
							<h6 style={{whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', width: '100%'}}>{provider.isActive && provider.accounts && provider.accounts[0] && provider.accounts[0].address}</h6>
						</div>
